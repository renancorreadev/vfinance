...
echo "Iniciando Node-3 do Besu QBFT..."

# Configurações específicas do Node-3
NODE_ID=3
RPC_PORT=8547
P2P_PORT=30305
KEY_FILE="data/key"
...
echo "Node-3 iniciado na porta RPC: $RPC_PORT, P2P: $P2P_PORT"
echo "Para ver logs: tail -f besu-node-3.log"
echo "Para parar: pkill -f 'besu.*Node-3'"
