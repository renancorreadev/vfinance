...
echo "Iniciando Node-2 do Besu QBFT..."

# Configurações específicas do Node-2
NODE_ID=2
RPC_PORT=8546
P2P_PORT=30304
KEY_FILE="data/key"
...
echo "Node-2 iniciado na porta RPC: $RPC_PORT, P2P: $P2P_PORT"
echo "Para ver logs: sudo journalctl -u besu-node-2.service -f"
echo "Para parar: sudo systemctl stop besu-node-2.service"
